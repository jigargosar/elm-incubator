                ...
                let
                    ...
                    newSubmenus =
                        onSubmenuStyle
                            (\i style ->
                                Animation.interrupt
                                    [ Animation.wait <| Time.millisToPosix <| round (toFloat i * 5.0e-2 * second)
            ...
            let
                ...
                newMessageAnim =
                    Animation.interrupt
                        ...
                        , Animation.wait <| Time.millisToPosix <| round (1 * second)
                        , Animation.to
                            [ Animation.opacity 0
                            ]
                        ]
...
makeSubmenu i icon =
    ...
    , style =
        Animation.styleWith (Animation.spring { stiffness = 400, damping = 28 }) <|
            ...
            , Animation.backgroundColor (Color 250 250 250 1)
